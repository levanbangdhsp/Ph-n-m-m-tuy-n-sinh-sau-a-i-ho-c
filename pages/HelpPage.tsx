...
                </>
            )}
      S      {renderSection('nop-ho-so', '2. Nộp Hồ sơ Dự tuyển', 2,
                <>
...
S                      <ImagePlaceholder src="/images/trang-thai-khong-hop-le.png" alt="Ví dụ về trạng thái hồ sơ không hợp lệ." />
                    </ul>
                </>
            )}
...
                        <>
                S        <p>Sử dụng thanh tìm kiếm trong phần "Danh sách thí sinh" để tìm kiếm nhanh một thí sinh theo Họ tên, Email, Số điện thoại hoặc Ngày sinh.</p>
...
                            </ul>
              S            <ImagePlaceholder src="/images/admin-quan-ly-can-bo.png" alt="Giao diện quản lý cán bộ dành cho Admin." />
content-fetch-id: uploaded:image_aff3c1.png-b942822b-64b5-4b86-8164-b9e6244de733
A
                        </>
                    )}
                </>
...
  S                <p>Nhấn vào "Xem hồ sơ" để xem chi tiết toàn bộ thông tin và các tài liệu mà thí sinh đã nộp. Tại đây, bạn cũng có thể chọn "Chỉnh sửa Hồ sơ" để thay đổi thông tin nếu cần.</p>
S                  <ImagePlaceholder src="/public/images/admin-tim-kiem.png" alt="Chức năng tìm kiếm và xem hồ sơ thí sinh." />
                  </>
                ))}
                {renderSection('admin-deadline', '3. Quản lý Hạn nộp', 2, (
                  <>
