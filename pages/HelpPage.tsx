          ...
          <div className="flex-1 bg-white p-8 rounded-lg shadow-md min-w-0">
            ...
            {renderSection('dang-ky', 'Đăng ký', 3, 
                <>
                    ...
                    <ImagePlaceholder src="/public/images/dang-ky.png" alt="Giao diện form đăng ký tài khoản." />
                </>
            )}
            {renderSection('dang-nhap', 'Đăng nhập', 3, 
                <>
                    ...
                    <ImagePlaceholder src="/public/images/dang-nhap.png" alt="Giao diện form đăng nhập." />
                </>
            )}
                ...
                <>
                    <p>Nếu bạn quên mật khẩu, hãy nhấp vào liên kết "Quên mật khẩu?" trên trang đăng nhập.</p>
                     <ol className="list-decimal list-inside space-y-2">
                        ...
                        <ImagePlaceholder src="/public/images/quen-mat-khau-1.png" alt="Bước 1: Nhập email để lấy lại mật khẩu." />
                        ...
                        <li><b>Bước 3:</b> Tạo mật khẩu mới và xác nhận. Sau khi thành công, bạn sẽ được chuyển về trang đăng nhập.</li>
                         <ImagePlaceholder src="/public/images/quen-mat-khau-2.png" alt="Bước 2 & 3: Nhập OTP và đặt mật khẩu mới." />
                    </ol>
                </>
            )}
            {renderSection('nop-ho-so', '2. Nộp Hồ sơ Dự tuyển', 2,
                <>
                    ...
                    <ImagePlaceholder src="/public/images/ho-so-cac-buoc.png" alt="Thanh tiến trình các bước nộp hồ sơ." />
                    ...
                    <ImagePlaceholder src="/public/images/ho-so-luu-nhap.png" alt="Chức năng Lưu nháp và điều hướng." />
                    ...
                    <ImagePlaceholder src="/public/images/ho-so-nop.png" alt="Bước cuối cùng: Xem lại và Nộp hồ sơ." />
                </>
            )}
            {renderSection('theo-doi', '3. Theo dõi Trạng thái', 2,
                <>
                    ...
                    <ul className="list-disc list-inside space-y-2">
                        ...
                        <ImagePlaceholder src="/public/images/trang-thai-cho-xu-ly.png" alt="Ví dụ về trạng thái đang xử lý." />
                        ...
                        <ImagePlaceholder src="/public/images/trang-thai-can-bo-sung.png" alt="Ví dụ về trạng thái cần bổ sung." />
                        <li><b>Hồ sơ hợp lệ:</b> Chúc mừng! Hồ sơ của bạn đã hợp lệ. Đây là điều kiện cần để được xét trúng tuyển.</li>
                        <ImagePlaceholder src="/public/images/trang-thai-hop-le.png" alt="Ví dụ về trạng thái hồ sơ hợp lệ." />
                        ...
                        <ImagePlaceholder src="/public/images/ket-qua-trung-tuyen.png" alt="Ví dụ về kết quả trúng tuyển, hiển thị rõ ngành và định hướng." />
                        ...
                        <ImagePlaceholder src="/public/images/ket-qua-khong-trung-tuyen.png" alt="Ví dụ về kết quả không trúng tuyển." />
                        <li><b>Hồ sơ không hợp lệ:</b> Rất tiếc, hồ sơ của bạn không hợp lệ. Lý do sẽ được ghi rõ trong thông báo.</li>
                        <ImagePlaceholder src="/public/images/trang-thai-khong-hop-le.png" alt="Ví dụ về trạng thái hồ sơ không hợp lệ." />
                    </ul>
                </>
            )}
                ...
                <>
                    ...
                    {renderSection('admin-dashboard', '1. Bảng điều khiển', 2, 
                        <>
                            ...
                            <ImagePlaceholder src="/public/images/admin-dashboard.png" alt="Giao diện bảng điều khiển của Admin." />
                        </>
                    )}
                    {renderSection('admin-search', '2. Tìm kiếm và Xem hồ sơ', 2, 
                        <>
                            ...
                            <ImagePlaceholder src="/public/images/admin-tim-kiem.png" alt="Chức năng tìm kiếm và xem hồ sơ thí sinh." />
                        </>
                    )}
                    {renderSection('admin-deadline', '3. Quản lý Hạn nộp', 2, 
                        <>
                            ...
                            <ImagePlaceholder src="/public/images/admin-quan-ly-han-nop.png" alt="Giao diện quản lý hạn nộp hồ sơ." />
                        </>
                    )}
                    {renderSection('admin-staff', '4. Quản lý Cán bộ', 2, 
                        <>
                            ...
                            <ImagePlaceholder src="/public/images/admin-quan-ly-can-bo.png" alt="Giao diện quản lý cán bộ dành cho Admin." />
                        </>
                    )}
                </>
            )}
